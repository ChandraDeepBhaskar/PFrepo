...
public class BaseTest {
	...
	public void reportFail(String message) {
		...
		eTest.log(LogStatus.FAIL,message);//show fails in extent reports
		
		takeScreenshot();
		
		Assert.fail(message);//fails TestNG Results
	...
	public void takeScreenshot(){
		...
		try {
			...
			FileUtils.copyFile(scrFile, new File("screenshots//"+screenshotFile));//commons-io jar for FileUtils
